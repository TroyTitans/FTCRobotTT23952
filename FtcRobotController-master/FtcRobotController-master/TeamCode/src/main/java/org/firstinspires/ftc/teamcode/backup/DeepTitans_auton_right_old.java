...
@Autonomous(name="DeepTroyTitansAutonRight", group = "TroyTitans", preselectTeleOp = "TroyTitansDeepTeleop")
public class DeepTroyTitansAutonRight extends LinearOpMode
{
...
/*
        ...
        robot.drive( 40, 0.4, 0);
        robot.strafe( -15, strafePower, 0);

        //Push First piece
        robot.drive( -65, drivePower, 0);
        ...
        robot.specimenMove(35,70,strafePower,0);
        gripper.setPosition(gripperOpenPosition);
        sleep(500);
        ...
        robot.specimenMove(40,70,strafePower,0.5);
        gripper.setPosition(gripperClosedPosition);
        sleep(1000);
        ...
        robot.turnTo(0, 0.45, 0);
        robot.specimenMove(35,65,strafePower,0);
        gripper.setPosition(gripperOpenPosition);
        sleep(500);
